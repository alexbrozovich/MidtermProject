...
public class MidtermProjectMainApp {
	...
	public static void main(String[] args) {
		...
		int size = Validator.getInt(scan,
				"First things first, please enter the size of board you would like to play: (Example if you enter 3, your board will be 3x3)\n",
				3, 10);
